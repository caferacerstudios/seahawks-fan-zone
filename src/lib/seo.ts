...
export const PUBLIC_PAGES: SitemapPage[] = [
  ...
  { canonicalPath: "/players", title: "Seattle Seahawks Roster | Seahawks Fan Zone", description: "Explore the current Seattle Seahawks roster, including active, practice-squad, and reserve players, plus clearly labeled historical player statistics." },
