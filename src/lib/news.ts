...
const articles: NewsArticle[] = [
  ...
  },
  {
    ...
    sources: [
      { label: "Seahawks Fan Zone roster", url: "/players" },
      { label: "Seahawks Fan Zone methodology", url: "/methodology" },
    ],
    hero: sharedHero,
    featured: false,
