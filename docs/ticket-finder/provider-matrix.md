...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Ticketmaster | APPROVED: Discovery API | Event summary only | Not established | Event ID/name/URL, venue, date/time/timezone, event status, currency, genuine price ranges | Not established; never assumed fee-complete | Account quota | 10-minute cache | 60-minute last-good window | No raw response/history | Not established | Plain-text provider name | Operator approval; `provider-rights/Ticketmaster.md` | ENABLED only by operator env |
