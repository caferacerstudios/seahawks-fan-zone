...
| EventSpy | APPROVED: accountless retrieval of one exact public URL only | Aggregate lowest/get-in market observation; not inventory or a provider range | Not established | Exact source/event/game identity, lowest observed price, explicitly supplied seven-day low and winning marketplace, USD fee basis and timestamps | Estimated fees and taxes where available, otherwise unknown | No more than twice daily | Twice daily | PENDING operator confirmation | PENDING operator confirmation; no history approved | Not approved | Plain-text EventSpy, exact source link, metric/time/fee qualification | Operator permission evidence held outside repository; `provider-rights/EventSpy.md` | DISABLED — sanitized-fixture parser only; no network, pipeline, snapshot, UI, or production configuration |
