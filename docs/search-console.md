...
1. Verify the canonical `https://seahawksfanzone.com/` property in Google Search Console using a supported verification method.
2. Deploy the site, then open `https://seahawksfanzone.com/sitemap.xml` and confirm it returns XML with a successful HTTP status.
